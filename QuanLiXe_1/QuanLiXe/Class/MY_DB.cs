...
namespace QuanLiXe
{
    class MY_DB
    {
        ...
        SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Do_An_Win\newest_1\gd2QLXmasterCopy\QuanLiXe_1\QuanLiXe\DESKTOP-RRRHOP4.mdf;Integrated Security=True;Connect Timeout=30");
